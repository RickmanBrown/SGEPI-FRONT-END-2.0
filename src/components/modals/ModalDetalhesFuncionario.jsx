      ...
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden animate-fade-in">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-blue-100 mt-1">
                Dados cadastrais e movimentações no sistema.
              </p>
            </div>
        ...
        <div className="p-6 space-y-5">
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
            ...
            <strong className="text-gray-800 text-lg">{funcionario.nome}</strong>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <InfoCard label="Departamento" valor={funcionario.departamentoNome} />
            <InfoCard label="Função" valor={funcionario.funcaoNome} />
            <InfoCard label="Entregas" valor={funcionario.totalEntregas} />
            <InfoCard label="Devoluções" valor={funcionario.totalDevolucoes} />
            <InfoCard
              label="Última movimentação"
              valor={funcionario.ultimaMovimentacao}
            />
            <InfoCard
